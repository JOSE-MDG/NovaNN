 ...
 *
 * @details
 * Queries @c cudaGetDeviceCount to determine whether a usable GPU
 ...
 *
 * @return @c true when a CUDA-capable device is found and
 ...
 * @ref isCudaDeviceAvailable.  The device index is @c 0 when a GPU
