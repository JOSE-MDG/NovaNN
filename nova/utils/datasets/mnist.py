...
from nova.utils.data import normalize, split_features_and_labels, Dataset
...
if TYPE_CHECKING:
    from nova._typing import Dtype, Mnist
...
def load_mnist_data(
    ...
    Examples:
        ...
        >>> ((x_train, y_train), (x_test, y_test), (x_val, y_val)) = mnist.load_mnist_data(
            as_tensor=True,
            tensor4d=True,
            dtype=nova.float32,
        )
