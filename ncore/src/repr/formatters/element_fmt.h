 ...
 * @param[in]  elem_ptr  Pointer to the element value in tensor storage.
 * @param[in]  ten       The owning tensor (needed for scale_/zero_point_).
 * @param[in]  ctx       ReprContext with precision, sci, is_bool, etc.
 ...
 *
 * Looks up g_element_formatters[ten->dtype] and calls the handler.
 *
 * @param[out] buf      Output buffer.
 * @param[in]  buf_size Output buffer size.
 * @param[in]  ptr      Pointer to the element value.
 * @param[in]  ten      Owning tensor.
