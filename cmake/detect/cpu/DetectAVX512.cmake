...
if(HAS_AVX512F)
    ...
    ")
    check_simd(HAS_AVX512_FP16 "-mavx512f -mavx512fp16" "
        #include <immintrin.h>
        int main() { __m512h a = _mm512_set1_ph(1.0f); (void)_mm512_add_ph(a, a); return 0; }
    ")
    check_simd(HAS_AVX512_BF16 "-mavx512f -mavx512bf16" "
        #include <immintrin.h>
