 ...
 * @ref deviceRelease, @ref deviceResize, and @ref deviceMemcpy
 ...
 * wins.  This function is called by @ref deviceMemcpy,
 * @ref device_memcpy_c and FFI Rust wrappers (in `ncore/rust/src`)
