...
typedef struct {
  ...
  size_t threshold;      /**< Element count above which summarisation
                              kicks in.  Default: 1000. */
  size_t edge_items;     /**< Elements shown per edge when summarised.
                              Default: 3. */
  size_t linewidth;      /**< Soft maximum line width (reserved).
                              Default: 80. */
  int precision;         /**< Number of decimal places for floats.
                              Default: 4. */
