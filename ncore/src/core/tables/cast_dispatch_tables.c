...
__attribute__((constructor)) static inline void init_cast_dispatch() {
  ...
  cast_dispatch[Float16][Sined8] = tfp16_to_s8_;
  ...
  cast_dispatch[BFloat16][Sined8] = tbf16_to_s8_;
  ...
  cast_dispatch[Float32][Sined8] = tf32_to_s8_;
  ...
  cast_dispatch[Float64][Sined8] = tf64_to_s8_;
  ...
  cast_dispatch[Sined8][Float16] = ts8_to_fp16_;
  cast_dispatch[Sined8][BFloat16] = ts8_to_bf16_;
  cast_dispatch[Sined8][Float32] = ts8_to_f32_;
  cast_dispatch[Sined8][Float64] = ts8_to_f64_;
  ...
  cast_dispatch[Sined8][Signed32] = ts8_to_s32_;
  cast_dispatch[Sined8][Signed64] = ts8_to_s64_;
  cast_dispatch[Signed32][Sined8] = ts32_to_s8_;
  cast_dispatch[Signed32][Signed64] = ts32_to_s64_;
  cast_dispatch[Signed64][Sined8] = ts64_to_s8_;
  ...
  cast_dispatch[Sined8][UnSigned8] = ts8_to_u8_;
  cast_dispatch[Sined8][UnSigned32] = ts8_to_u32_;
  cast_dispatch[Sined8][UnSigned64] = ts8_to_u64_;
